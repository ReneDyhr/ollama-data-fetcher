            ...
            for section in sections:
                ...
                for sibling in section.next_siblings:
                    if sibling.name in ["h1", "h2", "h3"]:
                        break
                    if sibling.name in ["div"] and "mw-collapsible" in sibling['class'] and "unique-mw-collapsed" not in sibling['class']:
                    ...
                    if sibling.name in ["div"] and "mw-collapsible" in sibling['class'] and "unique-mw-collapsed" in sibling['class']:
